...
function Footer() {
  return (
        ...
        <footer className="footer text-base-content p-10  bg-gradient-to-r from-green-600 via-green-400 to-lime-300 " >
        <div className='container mx-auto flex flex-col md:flex-row justify-between flex-wrap gap-10 text-white'>
  ...
  <a className="link link-hover">Turf Booking</a>
